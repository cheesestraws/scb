...
type FetchFunc func(ctx context.Context, device string, user string, pass string, reserved interface{}) (io.Reader, error)

var kinds = make(map[string]FetchFunc)

func Fetch(ctx context.Context, kind string, device string, user string,
	pass string, reserved interface{}) (io.Reader, error) {
